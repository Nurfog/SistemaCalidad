...
Write-Host "  • TAMA LAS TABLAS de la base de datos (excepto usuarios/permisos)"
Write-Host "  • Todos los documentos y versiones"
Write-Host "  • Todos los archivos físicos del bucket S3"
Write-Host "  • Registros, No Conformidades, Auditorías y Anexos"
